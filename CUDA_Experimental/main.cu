...
#define MAX_NODES 100000    // Maximum nodes in the tree (adjust based on expected size & GPU memory)
...
#define OBSTACLE1_HEIGHT (0.4f * WORLD_HEIGHT)
                             ...
                             const Obstacle* obstacles, int num_obstacles)
{
    ...
    // TODO: Implement a more robust line segment-AABB intersection if needed.
    // Example resources: Real-Time Collision Detection by Christer Ericson
