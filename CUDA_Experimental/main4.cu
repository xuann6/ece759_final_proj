...
#define GOAL_X 900.0f
#define GOAL_Y 900.0f
...
int main() {
    ...
    for (iteration = 0; iteration < MAX_ITERATIONS; ++iteration) {
        ...
        const int check_interval = 50; // Check more frequently due to more blocks working in parallel
